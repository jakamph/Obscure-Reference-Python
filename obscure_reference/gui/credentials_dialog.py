...
class Credentials_Dialog(ModalDialog):
    ...
    def __init__(self):
        """This method is the contructor for a new credentials dialog."""
        ...
        self.place(self.password_box,
                   top = self.user_box.bottom + 10,
                   right = label.right)
        self.place(self.ok_button,
                   top = self.password_box.bottom + 20,
                   right = label.right)
        self.place(self.cancel_button,
                   top = self.ok_button.top,
                   right = self.ok_button.left - 20)
